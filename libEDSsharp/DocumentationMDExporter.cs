...
{
    public class DocumentationMDExporter : IExporter
    {
        StreamWriter file = null;

        public DocumentationMDExporter(string fileName, EDSsharp eds, string gitVersion) : base(fileName, eds, gitVersion)
        {
        }
