...
{
    public class DocumentationHTMLExporter : IExporter
    {
        StreamWriter file = null;

        public DocumentationHTMLExporter(string fileName, EDSsharp eds, string gitVersion) : base(fileName, eds, gitVersion)
        {
        }
        ...
        public void export_html(string filepath)
        {
        ...
        public void genmddoc(string filepath)
        {
            file = new StreamWriter(filepath, false);
            file.NewLine = "\n";
